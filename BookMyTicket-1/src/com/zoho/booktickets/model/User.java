...
public class User{
    ...
    public User(long userId, String role, String name, String mobNo,String emailId, String sex){
        this.userId = userId;
        this.role = role;
        this.name = name;
        this.mobNo = mobNo;
    ...
    public User(String role, String name, String mobNo,String emailId, String sex){
        this.role = role;
        this.name = name;
        this.mobNo = mobNo;
        this.emailId = emailId;
