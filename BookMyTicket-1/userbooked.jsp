...
<html>
	...
	<body>
     ...
     <%if(request.getParameter("bookedId") != null){%>
        ...
        <h2 style="text-align:center;">Booking Id :<%= request.getParameter("bookedId")%> Details</h2>
        <%Booking booking = new BookingService().read(Long.parseLong(request.getParameter("bookedId")));
          ...
          <table class="booking-table" BORDER="1">
            ...
            <tr> <td>Booked Seats:</td> <td><%= Arrays.toString(booking.getNoOfBookedSeats())%></td><tr>
