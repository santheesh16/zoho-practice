...
public class QueryStatement {
	...
	public static final String CREATE_USER_TABLE = "CREATE TABLE users (user_id serial PRIMARY KEY,username VARCHAR ( 50 ) NOT NULL,mob_no VARCHAR ( 20 ) NOT NULL,email_id VARCHAR ( 255 ) NOT NULL,sex  VARCHAR ( 10 ) NOT NULL);";
